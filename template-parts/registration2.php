...
<div class="container">
  <div class="row">
    <div class="col-md-6 col-md-offset-3">
      <div class="wrap">
        <h1 id="add-new-site">Add New Site</h1>
        <form method="post" action="<?php echo network_admin_url( 'site-new.php?action=add-site' ); ?>" novalidate="novalidate">
          <input type="hidden" id="_wpnonce_add-blog" name="_wpnonce_add-blog" value="b05dd3c7fb" /><input type="hidden" name="_wp_http_referer" value="/qilata/wp-admin/network/site-new.php" />    <table class="form-table">
          <tr class="form-field form-required">
            <th scope="row"><label for="site-address">Site Address (URL)</label></th>
            <td>
              www.irfan.com/qilata/<input name="blog[domain]" type="text" class="regular-text" id="site-address" aria-describedby="site-address-desc"  autocapitalize="none" autocorrect="off" />
              <p class="description" id="site-address-desc">Only lowercase letters (a-z), numbers, and hyphens are allowed.</p>            </td>
            </tr>
            <tr class="form-field form-required">
            ...
            <tr class="form-field form-required">
              <th scope="row"><label for="site-language">Site Language</label></th>
              <td>
                <select name="WPLANG" id="site-language"><optgroup label="Installed">
            ...
            <p class="submit"><input type="submit" name="add-site" id="add-site" class="button button-primary" value="Add Site"  /></p>    </form>
    <div class="container">
  <div class="row">
<div class="col-md-6 col-md-offset-3">            
